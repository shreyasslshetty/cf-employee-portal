...
<cfif #URL.From# IS "DoFlag">

<!---<CFUPDATE DATASOURCE="koalaSQL" TABLENAME="web_admin_users" formfields="VISIBLE_REC">--->
	<cfquery name="DelEmployeeInfo" datasource="koalaSQL">
         UPDATE web_admin_users SET VISIBLE_REC = 0 where ID = #Form.ID#
</cfquery>
...
<html>
	...
	<body>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#resources" class="dropdown-toggle" data-toggle="dropdown"><b class="caret"></b></a>
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="http://192.168.98.108/employee/del_emp.cfm">Delete Employee</a></li>
		...
		<!-- <i class="icon-calendar icon-large"> -->
			<center><h1 style="color:#669bc9;"></i>Delete Employee Details<!-- <i class="icon-calendar-empty"></i> --></h1></center><br>
			<center><p style="color:#00437f">Select employee to delete from below.</p></center>
		...
		<div class="body-content">
			...
			<div class="col-lg-12" style="border: solid 1px grey; margin-bottom: 10%;">
				...
				<cfif GetEmployeeInfo.recordcount gt 0>
					...
					<h3>
						...
						<table id="emp_list" class="table table-striped table-bordered table-sm mt32 customers-list" style="width: 100%; text-align: center; border: solid 1px black; cellspacing="0" ">
                            ...
                            <!-- If URL.From just equals DoFlag, we simply just output the data, just as if it was undefined  -->
                            ...
                            <tr style="text-align: center; border: solid 1px black;">
                                   ...
                                   <td style="text-align: center; border: solid 1px black; font:small-caption;">#ADMIN_PASS#</td>
                                   ...
                                   <td style="text-align: center; border: solid 1px black;">
									   ...
									   <form action="del_emp.cfm?From=Edit&id=#ID#" method="post">
										   
										    <input type="image" src="images/delete-table.png" alt="Submit">
                             ...
                             <form action="del_emp.cfm?From=DoFlag&id=#ID#" onSubmit="return confirm('Confirm Delete?')"  method="post">
								 
								 <section class="sortedTable">
							...
							<td style="text-align: center; border: solid 1px black;"><select id="celu" name="IS_CELERANT" value="#IS_SUPER#"> <option>0</option> <option selected>1</option></select> </td>	 
							 ...
							 <td style="text-align: center; border: solid 1px black;">
								 ...
								 <input style="background-color: red; color:white; border: black solid 1px;" type="submit" value="Delete"></td>	 
                            ...
                            <!-- This is where the Edit button and form is created -->
                                  ...
                                  <td style="text-align: center; border: solid 1px black;">
                                          ...
                                          <form action="del_emp.cfm?From=Edit&id=#ID#" onsubmit="return validate(this);" method="post">
			...
			<!-- Copyright -->
				...
				<a href="http://192.168.98.108/employee/index.cfm"> CT Corp.</a>
				</div>
			<!-- Copyright -->
