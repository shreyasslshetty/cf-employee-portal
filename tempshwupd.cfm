					...
					<h3>
						...
						<table id="order-history" class="table table-striped mt32 customers-list" style="width: 100%; text-align: center; border: solid 1px black;">
                            ...
                            <tr>
                                   ...
                                   <td style="text-align: center; border: solid 1px black; display: none;">#ADMIN_PASS#</td>
                                   ...
                                   <td style="text-align: center; border: solid 1px black;">
									   ...
									   <form action="tempshwupd.cfm?From=Edit&id=#ID#" method="post">
                             ...
                             <form action="tempshwupd.cfm?From=DoEdit&id=#ID#" onSubmit="return confirm('Confirm Update?')"  method="post">
                             ...
                             <td style="text-align: left; border: solid 1px black;"><input type="password" name="ADMIN_PASS" id="pas1" size="5" value="#ADMIN_PASS#"> <input type="checkbox" onclick="Toggle()"> <b>Show</b> </td>
								 
								 
							 <td style="text-align: left; border: solid 1px black;"><select id="supu" name="IS_SUPER" value="#IS_SUPER#"> <option>0</option> <option selected>1</option></select> </td>	
								 
							<td style="text-align: left; border: solid 1px black;"><select id="celu" name="IS_CELERANT" value="#IS_SUPER#"> <option>0</option> <option selected>1</option></select> </td>	 
                             ...
                             <td style="text-align: left; border: solid 1px black;"><input type="datetime-local" name="LAST_FAILED_DTE" value="#LAST_FAILED_DTE#"></td>
                             <td style="text-align: left; border: solid 1px black;"><input type="datetime-local" name="DLU" value="#DLU#"></td>
                            ...
                            <!-- This is where the Edit button and form is created -->
                                  ...
                                  <td>
                                          ...
                                          <form action="tempshwupd.cfm?From=Edit&id=#ID#" onsubmit="return validate(this);" method="post">
                                          <input type="submit" value="Edit">
